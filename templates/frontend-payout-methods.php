    ...
    <div id="edd_user_payout_methods">
        ...
        <div class="edd_payout_methods">
            ...
            <div class="edd_payout_method <?php print esc_attr( $id ); ?>" data-name="<?php print esc_attr( $method->get_name() ); ?>">
                ...
                <a href="<?php print $method->get_enable_uri(); ?>" class="edd_payout_method_action" data-payout-method="<?php print esc_attr( $id ); ?>"><?php print ! $enabled ? __( 'Enable', 'edd-commissions-payouts' ) : __( 'Remove', 'edd-commissions-payouts' ); ?></a>
            </div>
